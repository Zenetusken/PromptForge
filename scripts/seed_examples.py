...
EXAMPLE_OPTIMIZATIONS = [
    {
        ...
        "optimization_notes": "Enhanced with structured requirements and role-based context.",
        "clarity_score": 0.92,
    ...
    },
    {
        ...
        "optimization_notes": "Applied role-based framework with structured output sections.",
        "clarity_score": 0.90,
