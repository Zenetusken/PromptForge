...
@router.post("/api/projects", response_model=ProjectDetailResponse, status_code=201)
...
@router.put("/api/projects/{project_id}", response_model=ProjectDetailResponse)
...
@router.put("/api/projects/{project_id}/prompts/reorder")
...
@router.get(
    "/api/projects/{project_id}/prompts/{prompt_id}/versions",
...
@router.get(
    "/api/projects/{project_id}/prompts/{prompt_id}/forges",
...
@router.put(
    "/api/projects/{project_id}/prompts/{prompt_id}",
    response_model=PromptResponse,
)
...
@router.delete("/api/projects/{project_id}/prompts/{prompt_id}")
