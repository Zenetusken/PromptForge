...
from apps.promptforge.utils.scores import round_score, score_threshold_to_db
...
class OptimizationRepository:
    ...
    async def get_stats(self, project: str | None = None) -> dict[str, Any]:
        ...
        base_query = select(
            ...
            func.avg(Opt.conciseness_score).label("avg_conciseness"),
            func.avg(Opt.framework_adherence_score).label("avg_framework_adherence"),
        ...
        if total == 0:
            return {
                ...
                "average_conciseness_score": None,
                "average_framework_adherence_score": None,
        ...
        return {
            ...
            "average_conciseness_score": round_score(row.avg_conciseness),
            "average_framework_adherence_score": round_score(row.avg_framework_adherence),
